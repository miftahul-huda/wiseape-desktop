	...
	var methods = {
		...
		createImageContext: function(event,cMenuUl){
			...
			var onSave = function(){
				...
				{
					methods.showMessage.apply(this,["imageErrMsg","Please enter valid numeric width"]);
					return false;
				}

				if(imageHeight != "" && isNaN(Number(imageHeight)))
				{
					methods.showMessage.apply(this,["imageErrMsg","Please enter valid numeric height"]);
					return false;
				}
